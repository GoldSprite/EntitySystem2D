...
namespace GoldSprite.UnityPlugins.MyInputSystem {
    ...
    public class ShowUInputManagerAttribute : PropertyAttribute { }

#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(ShowUInputManagerAttribute))]
    public class MyUInputManagerDrawer : PropertyDrawer {
